...
# -------------------------------------------
@metadata
def bamboo_manifest() -> NeoMetadata:
    """
    Bamboo
    """
    meta = NeoMetadata()
    meta.author = "@xinqiu_bot"  # TODO_TEMPLATE
    meta.description = "Bamboo contract"  # TODO_TEMPLATE
    meta.email = "bamboo"  # TODO_TEMPLATE
...
# Symbol of the Token
TOKEN_SYMBOL = 'Bamboo'  # TODO_TEMPLATE
